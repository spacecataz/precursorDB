...
custom_lines = [Line2D([0], [0], color='#ff6961', lw=1),
                Line2D([0], [0], color='#ffb480', lw=1),
                Line2D([0], [0], color='#f8f38d', lw=1),
                Line2D([0], [0], color='#42d6a4', lw=1),
                Line2D([0], [0], color='#08cad1', lw=1),
                Line2D([0], [0], color='#59adf6', lw=1),
                Line2D([0], [0], color='#9d94ff', lw=1),
                Line2D([0], [0], color='#c780e8', lw=1)]
...
for number in range(281):
    ...
    for num, item in enumerate(LT00[1][1]):
        ...
        ax.plot(LT03[0], LT03[1][2][num], color = '#ffb480')
        ax.plot(LT06[0], LT06[1][2][num], color = '#f8f38d')
        ax.plot(LT09[0], LT09[1][2][num], color = '#42d6a4')
        ax.plot(LT12[0], LT12[1][2][num], color = '#08cad1')
        ax.plot(LT15[0], LT15[1][2][num], color = '#59adf6')
        ax.plot(LT18[0], LT18[1][2][num], color = '#9d94ff')
        ax.plot(LT21[0], LT21[1][2][num], color = '#c780e8')
