...
import numpy as np
from os.path import exists, split, makedirs
...
def gmp_timeseries(IMFd, IMFu, Vsw, dT=60, r0=100, w_csheet=128, dI=0.1):
    """
...
if __name__ == '__main__':
    ...
    for dI in range(1, 100, 1):#np.arange(0.01, 0.11, 0.01):
        timeseries = gmp_timeseries([0, 0, -5], [0, 0, 127], [-2700, 0, 0], dI=dI*0.1)
        #export_timeseries(timeseries, f'ts_out_{dI*0.1}.txt')
