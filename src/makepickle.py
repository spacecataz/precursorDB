...
day = mags['time'][ind].day
month = mags['time'][ind].month
year = mags['time'][ind].year
...
#generate timeseries
timeseries = gmp_timeseries([0,IMFdy,IMFdz], [0,IMFuy,IMFuz], [-Vsw,0,0] , r0 = 250, w_csheet=128)
...
f_out = open('precursorDB/docs/pickles/'+str(year)+str(month)+str(day)+'_timeseries.pkl','wb')
