...
plt.savefig('precursorDB/docs/EventList/SEA/EventsSummary/'+str(onset.year)+f"{onset.month:02}"+f"{onset.day:02}"+'/SEA_subtraction/'+fileName+'_x.png')
...
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%H:%M'))
axs[2].set_xlabel('UT (HH:MM)')
plt.savefig('precursorDB/docs/EventList/SEA/EventsSummary/'+str(onset.year)+f"{onset.month:02}"+f"{onset.day:02}"+'/SEA_subtraction/'+fileName+'_y.png')
...
plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%H:%M'))
axs[2].set_xlabel('UT (HH:MM)')
plt.savefig('precursorDB/docs/EventList/SEA/EventsSummary/'+str(onset.year)+f"{onset.month:02}"+f"{onset.day:02}"+'/SEA_subtraction/'+fileName+'_z.png')